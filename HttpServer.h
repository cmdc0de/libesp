...
private:
	friend class libesp::HttpServerTask;
	friend class libesp::WebSocket;
	...
	libesp::Socket                   m_socket;
	bool                     m_useSSL;             // Is this server listening on an HTTPS port?
	uint32_t                 m_clientTimeout;      // Default Timeout
	libesp::FreeRTOS::Semaphore      m_semaphoreServerStarted = libesp::FreeRTOS::Semaphore("ServerStarted");
}; // HttpServer
