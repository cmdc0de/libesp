...
template<typename T> struct vec<3, T> {
	...
	///////////////////////////////////////////////////////////
	//dot V1 . V2 = a1a2+b1b2+c1c2
	// two vectors are perpendicular (orthogonal) if and only if V1 . V2 = 0
	//	dot (this) with t
	////////////////////////////////////////////////////////////
	T dot(const vec<3, T> &r) const {
...
template<size_t DimRows, size_t DimCols, typename T> class mat {
	...
	void setRotation(float f) {
		rows[2][2] = rows[0][0] = libesp::fastcos(f);
		rows[0][2] = libesp::fastsin(f);
