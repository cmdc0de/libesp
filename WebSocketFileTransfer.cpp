 ...
 */
libesp::WebSocketFileTransfer::WebSocketFileTransfer(std::string rootPath) {
 ...
 */
class FileTransferWebSocketHandler : public libesp::WebSocketHandler {
private:
...
public:
	 ...
	 */
	virtual void onMessage(libesp::WebSocketInputStreambuf* pWebSocketInputStreambuf) {
...
void libesp::WebSocketFileTransfer::start(libesp::WebSocket* pWebSocket) {
