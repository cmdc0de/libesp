...
const char libesp::HttpRequest::HTTP_HEADER_ACCEPT[]         = "Accept";
const char libesp::HttpRequest::HTTP_HEADER_ALLOW[]          = "Allow";
const char libesp::HttpRequest::HTTP_HEADER_CONNECTION[]     = "Connection";
const char libesp::HttpRequest::HTTP_HEADER_CONTENT_LENGTH[] = "Content-Length";
const char libesp::HttpRequest::HTTP_HEADER_CONTENT_TYPE[]   = "Content-Type";
const char libesp::HttpRequest::HTTP_HEADER_COOKIE[]         = "Cookie";
const char libesp::HttpRequest::HTTP_HEADER_HOST[]           = "Host";
const char libesp::HttpRequest::HTTP_HEADER_LAST_MODIFIED[]  = "Last-Modified";
const char libesp::HttpRequest::HTTP_HEADER_ORIGIN[]         = "Origin";
const char libesp::HttpRequest::HTTP_HEADER_SEC_WEBSOCKET_ACCEPT[]   = "Sec-WebSocket-Accept";
const char libesp::HttpRequest::HTTP_HEADER_SEC_WEBSOCKET_PROTOCOL[] = "Sec-WebSocket-Protocol";
const char libesp::HttpRequest::HTTP_HEADER_SEC_WEBSOCKET_KEY[]      = "Sec-WebSocket-Key";
const char libesp::HttpRequest::HTTP_HEADER_SEC_WEBSOCKET_VERSION[]  = "Sec-WebSocket-Version";
const char libesp::HttpRequest::HTTP_HEADER_UPGRADE[]        = "Upgrade";
const char libesp::HttpRequest::HTTP_HEADER_USER_AGENT[]     = "User-Agent";

const char libesp::HttpRequest::HTTP_METHOD_CONNECT[] = "CONNECT";
const char libesp::HttpRequest::HTTP_METHOD_DELETE[]  = "DELETE";
const char libesp::HttpRequest::HTTP_METHOD_GET[]     = "GET";
const char libesp::HttpRequest::HTTP_METHOD_HEAD[]    = "HEAD";
const char libesp::HttpRequest::HTTP_METHOD_OPTIONS[] = "OPTIONS";
const char libesp::HttpRequest::HTTP_METHOD_PATCH[]   = "PATCH";
const char libesp::HttpRequest::HTTP_METHOD_POST[]    = "POST";
const char libesp::HttpRequest::HTTP_METHOD_PUT[]     = "PUT";
 ...
 */
libesp::HttpRequest::HttpRequest(Socket clientSocket) {
...
libesp::HttpRequest::~HttpRequest() {
} // ~HttpRequest
 ...
 */
std::string libesp::HttpRequest::getBody() {
 ...
 */
std::string libesp::HttpRequest::getHeader(std::string name) {
	return m_parser.getHeader(name);
} // getHeader


std::map<std::string, std::string> libesp::HttpRequest::getHeaders() {
	return m_parser.getHeaders();
} // getHeaders


std::string libesp::HttpRequest::getMethod() {
	return m_parser.getMethod();
} // getMethod


std::string libesp::HttpRequest::getPath() {
 ...
 */
std::map<std::string, std::string> libesp::HttpRequest::getQuery() {
 ...
 */
libesp::Socket libesp::HttpRequest::getSocket() {
		return m_clientSocket;
} // getSocket


std::string libesp::HttpRequest::getVersion() {
	return m_parser.getVersion();
} // getVersion


libesp::WebSocket* libesp::HttpRequest::getWebSocket() {
	return m_pWebSocket;
} // getWebSocket
 ...
 */
bool libesp::HttpRequest::isClosed() {
	return m_isClosed;
} // isClosed
 ...
 */
bool libesp::HttpRequest::isWebsocket() {
 ...
 */
std::map<std::string, std::string> libesp::HttpRequest::parseForm() {
 ...
 */
std::vector<std::string> libesp::HttpRequest::pathSplit() {
 ...
 */
std::string libesp::HttpRequest::urlDecode(std::string str) {
