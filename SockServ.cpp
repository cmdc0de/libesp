 ...
 */
libesp::SockServ::SockServ(uint16_t port) : SockServ() {
	this->m_port = port;
 ...
 */
/* static */ void libesp::SockServ::acceptTask(void* data) {
 ...
 */
int libesp::SockServ::connectedCount() {
 ...
 */
void libesp::SockServ::disconnect(Socket s) {
 ...
 */
size_t libesp::SockServ::receiveData(Socket s, void* pData, size_t maxData) {
 ...
 */
void libesp::SockServ::sendData(std::string str) {
 ...
 */
void libesp::SockServ::sendData(uint8_t* data, size_t length) {
 ...
 */
void libesp::SockServ::setPort(uint16_t port) {
	m_port = port;
} // setPort


void libesp::SockServ::setSSL(bool use) {
	m_useSSL = use;
} // setSSL
...
void libesp::SockServ::start() {
	...
	libesp::FreeRTOS::startTask(acceptTask, "acceptTask", this, 6*1024);
} // start
...
libesp::Socket libesp::SockServ::waitForData(std::set<Socket>& socketSet) {
	fd_set readSet;
	int maxFd = -1;
 ...
 */
libesp::Socket libesp::SockServ::waitForNewClient() {
