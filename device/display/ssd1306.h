#ifndef LIBESP_SSD1306_H
#define LIBESP_SSD1306_H 
 ...
 *
	...
	VCC        |3.3V         |
	GND        |GND          |
	SCL        |GPIO_NUM22   |Serial clock line
	SDA        |GPIO_NUM21   |Serial data line
 */
...
public:
	...
	static const uint8_t COLOR_WHITE=0x01;
public:
	SSD1306();
	/**
	 * @brief  Initializes SSD1306 OLED
	 */
	bool init(ESP32_I2CMaster *i2c, bool bEnablePullUps);
	/** 
	 ...
	 */
	char putc(char ch, WFontDef_t* Font, uint8_t color);
	/**
	 * @brief  Puts string to internal RAM
	 * @note   @ref updateScreen() must be called after that in order to see updated LCD screen
	 * @param  *str: String to be written
	 * @param  *Font: Pointer to @ref FontDef_t structure with used font
	 * @param  color: Color used for drawing. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
	 * @retval Zero on success or character value when function failed
	 */
	char puts(const char* str, WFontDef_t* Font, uint8_t color);
	/**
	 ...
	 * @retval None
	 */
	void image(uint8_t *img, uint8_t x, uint8_t y);
