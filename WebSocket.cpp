 ...
 */
class libesp::WebSocketReader: public Task {
public:
	WebSocketReader() {
		m_end = false;
	}
 ...
 */
void libesp::WebSocketHandler::onClose() {
 ...
 */
void libesp::WebSocketHandler::onMessage(WebSocketInputStreambuf* pWebSocketInputStreambuf, WebSocket *pWebSocket) {
 ...
 */
void libesp::WebSocketHandler::onError(std::string error) {
 ...
 */
libesp::WebSocket::WebSocket(Socket socket) {
 ...
 */
void libesp::WebSocket::close(uint16_t status, std::string message) {
 ...
 */
libesp::WebSocketHandler* libesp::WebSocket::getHandler() {
 ...
 */
libesp::Socket libesp::WebSocket::getSocket() {
	return m_socket;
} // getSocket
 ...
 */
void libesp::WebSocket::send(std::string data, uint8_t sendType) {
 ...
 * @param [in] sendType The type of payload.  Either SEND_TYPE_TEXT or SEND_TYPE_BINARY.
 */
void libesp::WebSocket::send(uint8_t* data, uint16_t length, uint8_t sendType) {
 ...
 *
 */
void libesp::WebSocket::setHandler(WebSocketHandler* pHandler) {
 ...
 */
void libesp::WebSocket::startReader() {
 ...
 */
libesp::WebSocketInputStreambuf::WebSocketInputStreambuf(
	Socket   socket,
	size_t   dataLength,
	uint8_t *pMask,
	size_t   bufferSize) {
 ...
 */
void libesp::WebSocketInputStreambuf::discard() {
	uint8_t byte;
 ...
 */
size_t libesp::WebSocketInputStreambuf::getRecordSize() {
	return m_dataLength;
} // getRecordSize
 ...
 *
 */
libesp::WebSocketInputStreambuf::int_type libesp::WebSocketInputStreambuf::underflow() {
 ...
 * @brief Destructor.
 */
libesp::WebSocketHandler::~WebSocketHandler() {
} // ~WebSocketHandler()
