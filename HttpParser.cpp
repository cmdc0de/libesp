...
std::string libesp::HttpParser::getBody() {
	return m_body;
}
 ...
 */
std::string libesp::HttpParser::getHeader(const std::string& name) {
	// We normalize the header name to be lower case.
...
std::map<std::string, std::string> libesp::HttpParser::getHeaders() {
	return m_headers;
} // getHeaders


std::string libesp::HttpParser::getMethod() {
	return m_method;
} // getMethod


std::string libesp::HttpParser::getURL() {
	return m_url;
} // getURL


std::string libesp::HttpParser::getVersion() {
	return m_version;
} // getVersion

std::string libesp::HttpParser::getStatus() {
    return m_status;
} // getStatus

std::string libesp::HttpParser::getReason() {
    return m_reason;
} // getReason
 ...
 */
bool libesp::HttpParser::hasHeader(const std::string& name) {
	// We normalize the header name to be lower case.
	std::string localName = name;
 ...
 */
void libesp::HttpParser::parse(Socket s) {
 ...
 */
/*
void libesp::HttpParser::parse(std::string message) {
...
//
void libesp::HttpParser::parseRequestLine(std::string &line) {
...
//
void libesp::HttpParser::parseResponse(std::string message)
{
	auto it = message.begin();
	auto line = toStringToken(it, message, lineTerminator);
...
//
void libesp::HttpParser::parseStatusLine(std::string &line)
{
